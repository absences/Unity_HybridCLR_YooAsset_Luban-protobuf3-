...
namespace GameFramework.UI
{
    ...
    public interface IUIManager
    {
        ...
        /// <returns>界面的序列编号。</returns>
        int OpenUIForm(string uiFormAssetName, string uiGroupName, uint priority);
        ...
        /// <param name="pauseCoveredUIForm">是否暂停被覆盖的界面。</param>
        /// <returns>界面的序列编号。</returns>
        int OpenUIForm(string uiFormAssetName, string uiGroupName, uint priority, bool pauseCoveredUIForm);
        ...
        /// <param name="userData">用户自定义数据。</param>
        /// <returns>界面的序列编号。</returns>
        int OpenUIForm(string uiFormAssetName, string uiGroupName, uint priority, object userData);
        ...
        /// <param name="userData">用户自定义数据。</param>
        /// <returns>界面的序列编号。</returns>
        int OpenUIForm(string uiFormAssetName, string uiGroupName, uint priority, bool pauseCoveredUIForm, object userData);

        UniTask<UIFormLogic> OpenUIFormAsync(string uiFormAssetName, string uiGroupName, uint priority, bool pauseCoveredUIForm, object userData);
        /// <summary>
        /// 关闭界面。
        /// </summary>
