...
namespace GameFramework.Resource
{
    ...
    public delegate void LoadAssetSuccessCallback(string assetName, HandleBase assetHandle, float duration, object userData);
    ...
    /// <param name="userData">用户自定义数据。</param>
    public delegate void LoadAssetFailureCallback(string assetName, EOperationStatus status, string errorMessage, object userData);
