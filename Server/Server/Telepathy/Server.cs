...
namespace Telepathy
{
    public class Server : Common
    {
        ...
        public void InitServerController()
        {
            ...
            OnConnected = (connectID) =>
            {
              
               // controllerManager.clientCtrl.AddClient(connectID);
            };
            OnDisconnected = (connectID) =>
            {
                //controllerManager.clientCtrl.RemoveClient(connectID);
            };

            OnData = controllerManager.OnData;
        }
        ...
        private const double UpdateInterval = NetworkDefine.UPDATE_DELTATIME / 1000.0f;
        public void Update()
        {
            ...
            if (_deltaTime > UpdateInterval)
            {
                ...
                controllerManager.DoUpdate((float)_deltaTime);
            }
        }
        #endregion
    }
